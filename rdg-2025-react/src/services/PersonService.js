...
export default class PersonService {
    ...
    static updatePerson = async (personId, firstName, lastName, summary, homePhone, mobilePhone, addressStreet, addressTown, addressPostcode, imageId) => {
    ...
    static updatePersonWithImage = async (personData, imageId) => {
        ...
        try {
            const response = await axios.patch(`http://localhost:8080/people/${personData.id}`,
                {
