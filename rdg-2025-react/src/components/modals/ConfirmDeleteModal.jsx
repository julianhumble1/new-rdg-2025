...
const ConfirmDeleteModal = ({ setShowConfirmDelete, venueToDelete, handleConfirmDelete }) => {
  return (
    <div className="fixed inset-0 p-4 flex flex-wrap justify-center items-center w-full h-full z-[1000] before:fixed before:inset-0 before:w-full before:h-full before:bg-[rgba(0,0,0,0.5)] overflow-auto font-[sans-serif]">
      <div className="w-full max-w-md bg-white shadow-lg rounded-lg p-6 relative">
        ...
        <div className="my-8 text-center">
          ...
          <h4 className="text-gray-800 text-lg font-semibold mt-4">Are you sure you want to delete &apos;{venueToDelete.name }&apos;?</h4>
        ...
        <div className="flex flex-col space-y-2">
          <button type="button" className="px-4 py-2 rounded-lg text-white text-sm tracking-wide bg-red-500 hover:bg-red-600 active:bg-red-500"
            onClick={() => handleConfirmDelete(venueToDelete)}>
            Delete
          </button>
