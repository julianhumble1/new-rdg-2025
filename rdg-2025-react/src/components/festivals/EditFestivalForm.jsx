...
const EditFestivalForm = ({ festivalData, handleEdit, setEditMode }) => {
  ...
  const [year, setYear] = useState({
    value: festivalData.year,
    label: festivalData.year,
  });
  const [month, setMonth] = useState(
    festivalData.month
      ? {
          value: festivalData.month,
          label: MonthDateUtils.monthMapping[festivalData.month],
        }
      : "",
  );
  const [description, setDescription] = useState(
    festivalData.description ? festivalData.description : "",
  );
