...
import { AltEditFestivalForm } from "./AltEditFestivalForm.jsx";

const AltFestivalPage = () => {
    ...
    return (
        <div>
            ...
            <div className="flex w-full justify-center">
                ...
                {(festivalData && editMode) &&
                    <AltEditFestivalForm festivalData={festivalData} handleEdit={handleEdit} setEditMode={setEditMode}/>
                }
            </div>
...
export default AltFestivalPage