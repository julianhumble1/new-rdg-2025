...
const AllFestivals = () => {
    ...
    return (
        <div>
            {showConfirmDelete &&
                <ConfirmDeleteModal setShowConfirmDelete={setShowConfirmDelete} itemToDelete={festivalToDelete} handleConfirmDelete={ handleConfirmDelete } />
            }
            ...
            <div className='grid lg:grid-cols-6 grid-cols-1'>
                <div className="col-span-1 rounded m-2 border bg-slate-200 max-h-fit drop-shadow-md lg:pb-6">
					<div className='flex flex-col'>
                        ...
                        <TextInput icon={MagnifyingGlassIcon} placeholder="Festival Name" className='m-2 mt-0' value={nameSearch} onChange={(e) => setNameSearch(e.target.value)} />
                ...
                <span className='col-span-5 p-2 pl-0 overflow-x-auto'>
                    <FestivalsTable festivals={festivals} handleDelete={handleDelete} nameSearch={nameSearch} venueSearch={venueSearch} />
                </span>
            </div>
        </div>
    )
