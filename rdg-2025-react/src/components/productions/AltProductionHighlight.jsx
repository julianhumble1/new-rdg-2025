...
const AltProductionHighlight = ({ productionData, setEditMode, handleDelete, image, fetchProductionData }) => {
    return (
        <div className="col-span-3 flex justify-center bg-slate-200">
            <div className="flex w-full">
                <ProductionImageWithUploadBox productionData={productionData} image={image} fetchProductionData={fetchProductionData} />
