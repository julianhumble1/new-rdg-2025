            ...
            <div className='grid lg:grid-cols-6 grid-cols-1'>
				<div className="col-span-1 rounded m-2 border bg-slate-200 max-h-fit drop-shadow-md lg:pb-6">
					<div className='flex flex-col'>
                        ...
                        <TextInput icon={MagnifyingGlassIcon} placeholder="Production Name" className='m-2 mt-0' value={nameSearch} onChange={(e) => setNameSearch(e.target.value)} />
                        <TextInput icon={MagnifyingGlassIcon} placeholder="Venue Name" className='m-2 mt-0' value={venueSearch} onChange={(e) => setVenueSearch(e.target.value)} />
                        <div className="m-2">
                            <ToggleSwitch checked={sundownersSearch} onChange={setSundownersSearch}  label="Sundowners Only?" />
                        </div>
					</div>
				</div>
				<span className='col-span-5 p-2 pl-0 overflow-x-auto'>
                    <ProductionsTable productions={productions} handleDelete={handleDelete} nameSearch={nameSearch} venueSearch={venueSearch} sundownersSearch={sundownersSearch} />
				</span>
			</div>
