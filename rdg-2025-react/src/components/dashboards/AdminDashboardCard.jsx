        ...
        <div className="hover:bg-slate-300 hover:drop-shadow-sm transition col-span-1 w-full">
            <div className="flex justify-center">
                <div className="flex flex-col p-6 my-6 text-lg w-3/4">
                    ...
                    <Link to={`/${basePath}/new`} className="underline text-blue-500 hover:text-blue-700 text-sm">
                        Add New {name !== "People" ? name.slice(0, -1): "Person"}
                    </Link>
                    {showSeeAll && (
                        <Link to={`/${basePath}`} className="underline text-blue-500 hover:text-blue-700 text-sm">
                            See All {name}
                        </Link>
                    )}
                </div>
