...
const ProductionImageWithUploadBox = ({ image, productionData, fetchProductionData }) => {
    ...
    const handleSubmitImage = async () => {
        ...
        const signatureResponse = await getCloudinaryProductionSignature(productionData.id);
    ...
    const getCloudinaryProductionSignature = async () => {
        try {
            const response = await CloudinaryService.getSignature(productionData.id, "flyers");
    ...
    const updateProductionImageId = async (imageId) => {
        try {
            const response = await ProductionService.updateProductionWithImage(productionData, imageId);
            console.log(response);
